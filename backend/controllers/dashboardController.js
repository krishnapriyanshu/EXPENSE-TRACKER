...
exports.getDashboardData = async (req, res) => {
    try {
        ...
        const userObjectId = new Types.ObjectId(String(userId)); // ✅ Fixed typo: ObjectId
        ...
        // Sum of expenses in last 30 days
        ...
        res.json({
            ...
            last60DaysIncome: {
                total: incomeLast60Days, // ✅ Fixed typo "totla"
